package edu.mx.tesoem.itics.danielspy.sqlconexiones;
...
public class editar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_descripcion = (EditText)findViewById(R.id.editText9);
        et_precio = (EditText)findViewById(R.id.editText8);
        et_correo = (EditText)findViewById(R.id.editText7);
        et_edad = (EditText)findViewById(R.id.editText10);
